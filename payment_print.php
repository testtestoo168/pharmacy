...
requireLogin();
$id = $_GET['id'] ?? 0;
$v = $pdo->prepare("SELECT * FROM payment_vouchers WHERE tenant_id = $tid AND branch_id = $bid AND id = ?");
$v->execute([$id]);
$v = $v->fetch();
...
<head>
    <meta charset="UTF-8">
    <title><?= t('prt.payment_voucher') ?> - <?= $v['voucher_number'] ?></title>
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .no-print button { background:#922b21; color:#fff; }
        ...
        @media print {
            ...
            .voucher { border:2px solid #922b21; width:100%; }
...
<div class="voucher">
    ...
    <div class="v-header">
        <div class="v-header-right">
            ...
            <div class="v-title-ar"><?= t('payments.payment_voucher') ?></div>
            <div class="v-title-en">PAYMENT VOUCHER</div>
    ...
    <div class="v-body">
        <div class="v-field">
            <div class="field-label">
                <?= t('prt.paid_to') ?>
                <span class="field-label-en">Paid To Mrs.</span>
            </div>
            <div class="field-value"><?= htmlspecialchars($v['paid_to']) ?></div>
        </div>
